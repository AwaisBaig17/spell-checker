function LiveSpellInstance($setup) {
  livespell.spellingProviders.push(this),
    (this.Fields = "ALL"),
    (this.IgnoreAllCaps = !0),
    (this.IgnoreNumeric = !0),
    (this.CaseSensitive = !0),
    (this.CheckGrammar = !0),
    (this.Language = "English (International)"),
    (this.MultiDictionary = !1),
    ...
    (this.ShowLangInContextMenu = !0),
    (this.BypassAuthentication = !1),
    (this.UserSpellingInitiated = !1),
    (this.UserSpellingComplete = !1),
    ...
    (this.FieldType = function (id) {
      ...
      return "INPUT" == TYPE || "TEXTAREA" == TYPE
        ? "value"
        : "IFRAME" == TYPE
        ? "iframe"
        : "innerHTML";
    ...
    (this.docRePaint = function () {
      for (
        var fieldIds = this.arrCleanFields(), i = 0;
        i < fieldIds.length;
        i++
      ) {
        var id = fieldIds[i],
    ...
    (this.docFocus = function (index) {
      for (
        ...
        oField.spellcheckproxy && (oField = oField.spellcheckproxy),
          i == index
            ? ((oField.className =
                "" + oField.className + " livespell_focus_glow"),
              oField.scrollIntoView(!1))
            : (oField.className = oField.className.replace(
                /livespell_focus_glow/g,
                ""
              ));
      }
    }),
    (this.docPickup = function () {
      for (
        var fieldIds = this.arrCleanFields(), docs = [], i = 0;
        i < fieldIds.length;
        i++
      ) {
        var val,
    ...
    (this.FieldModified = function () {
      try {
        this.spellWindowObject.isStillOpen() &&
          (this.spellWindowObject.dialog_win.hasFocus() ||
      ...
      for (
        ...
        if (!oField["livespell__listener_" + this.id()]) {
          ...
          var ty = this,
            ...
            t = this.FieldType(id);
          "value" === t && livespell.insitu.proxyDOM(id)
            ? livespell.events.add(
                livespell.insitu.proxyDOM(id),
                "blur",
                fn,
                !1
              )
            : livespell.events.add(oField, "change", fn, !1);
        }
      }
    }),
    (this.setFormVals = function (
      CaseSensitive,
      IgnoreAllCaps,
      IgnoreNumeric,
      CheckGrammar
    ...
    (this.CheckInWindow = function () {
      var Dwidth = 460,
        Dheight = 290;
      livespell.test.chrome() && ((Dwidth += 5), (Dheight += 5)),
        (this.UserSpellingInitiated = !0),
      ...
      var webkit = livespell.test.webkit(),
        canmodal = !(
          webkit ||
          (this.BypassAuthentication && livespell.test.IE())
        );
      livespell.test.IE() &&
      ...
      if ("jquery.ui" == wm.substr(0, 9) && (jQuery, !0) && ($.ui, !0)) {
        ...
        this.WindowMode.length > 10 &&
          (dialogClass = this.WindowMode.substr(10)),
          $("#livespell_jquery_ui_modal_frame").length ||
            $("body").append(
              "<div id='livespell_jquery_ui_modal' style='display:overflow:hidden'><iframe width='" +
                Dwidth +
                "' height='" +
                Dheight +
                "' scrolling='no' marginwidth='0' marginheight='0' frameborder=0 id='livespell_jquery_ui_modal_frame' src='about:blank'></iframe></div>"
            );
        var f = this,
          u = this.url(),
        ...
        return (
          dialogClass && (settings.dialogClass = dialogClass),
          void $("#livespell_jquery_ui_modal").dialog(settings)
        );
      }
      ...
      if ("modalbox" == wm && "undefined" != typeof Modalbox) {
        var HTMLIframe =
          ...
          "' height='" +
          Dheight +
          "' scrolling='no' marginwidth='0' marginheight='0'  frameborder='0' src='" +
          this.url() +
          "'  ></iframe>";
      ...
      livespell.test.BuggyAjaxInFireFox()
        ? (Dheight = 325)
        : livespell.test.IE6() && (Dheight = 333),
        "modal" == wm && window.showModalDialog && canmodal
          ? window.showModalDialog(
              this.url(),
              window,
              "center:1;dialogheight:" +
                Dheight +
                "px;dialogwidth:" +
                Dwidth +
                "px;resizable:0;scrollbars:0;scroll:0;location:0"
            )
          : "modeless" == wm && window.showModelessDialog && canmodal
          ...
          : window.open(
              ...
              "width=" +
                ...
                ",height=" +
                Dheight +
                ",scrollbars=no,resizable=no;centerscreen=yes;location=no;tolbar=no;menubar=no",
              !1
            );
    }),
    (this.url = function () {
    ...
    (this.m_AYTAjaxInervalHandler = function () {
      ...
      if (fieldIds.length) {
        for (var i = 0; i < fieldIds.length; i++) {
          ...
          if (oChild) {
            var found = !1;
            oChild.isCurrentAjaxImplementation !== !0 &&
              ((oChild.isCurrentAjaxImplementation = !0), (found = !0));
          }
        }
    ...
    (this.ActivateAsYouTypeOnLoad = function () {
      ...
      document.activeElement && (activeElement = document.activeElement),
        livespell.context.renderCss(this.CSSTheme);
      var o = this,
        fn = function () {
          var a = o,
    ...
    (this.ActivateAsYouType = function (activeElement) {
      if (
        (this.isUniPacked && (this.Fields = $Spelling.findf(this.Fields)),
        !livespell.test.browserNoAYT())
      ) {
        this.SetUserInterfaceLanguage(this.UserInterfaceLanguage),
          livespell.context.renderCss(this.CSSTheme);
        var fieldIds = this.arrCleanFields();
        ...
        for (var i = 0; i < fieldIds.length; i++) {
          var id = fieldIds[i];
          if (
            "textarea" == E$(id).nodeName.toLowerCase() ||
            ("input" == E$(id).nodeName.toLowerCase() && "text" == E$(id).type)
          ) {
            var oField = livespell.insitu.createProxy(id);
            if (!oField) return;
            activeElement && activeElement == E$(id) && oField.focus(),
              oField.setAttribute("autocheck", !0),
              (oField.autocheck = !0),
              (oField.autocheckProvider = this.id());
            var oChild = E$(id);
            (oChild.isCurrentAjaxImplementation = !0),
              (this.m_ayt = livespell.array.safepush(
                this.m_ayt,
    ...
    (this.getFieldWordListMech = function () {
      ...
      for (var i = 0; i < tokens.length; i++)
        if (livespell.test.isword(tokens[i]) === !0) {
          ...
          var mwm =
            (/[0-9]/gi.test(token) && this.IgnoreNumeric) ||
            (token.toUpperCase() == token && this.IgnoreAllCaps) ||
            livespell.test.spelling(token, this.Language);
          !mwm == !0 && (wasfine = !1),
            "undefined" == typeof mwm &&
              (token === token.toUpperCase() ||
                /[0-9]/gi.test(token) ||
                (this.IgnoreNumeric && livespell.test.num(token)) ||
    ...
    (this.AjaxValidateFields = function () {
      ...
      return wordlist.length <= 0
        ? this.onValidateMech(wasfine)
        : void livespell.ajax.send(
            "APIVALIDATE",
            wordlist.join(livespell.str.chr(1)),
            this.Language,
    ...
    (this.AjaxSpellCheck = function (input, makeSuggestions) {
      ...
      for (
        var wordstocheck = input.join ? input : [input], allFound = !0, i = 0;
        i < wordstocheck.length && allFound;
        i++
      ) {
        var word = wordstocheck[i];
        allFound =
          allFound &&
          livespell.test.fullyCached(word, this.Language, makeSuggestions);
      }
      return allFound
        ? void this.onSpellCheckFromCache(input, makeSuggestions)
        : void (input.join
    ...
    (this.SpellCheckSuggest = function (input) {
      for (
        ...
        var word = wordstocheck[i];
        allFound =
          allFound && livespell.test.fullyCached(word, this.Language, !0);
      }
      if (allFound) {
      ...
      return (
        (livespell.ajax.needsInstantSuggestion = !0),
        input.join
          ? ((input = input.join(livespell.str.chr(1))),
            livespell.ajax.send_sync(
              "APISPELLARRAY",
    ...
    (this.BinSpellCheck = function (input) {
      for (
        ...
        var word = wordstocheck[i];
        allFound =
          allFound && livespell.test.fullyCached(word, this.Language, !1);
      }
      if (allFound) {
        for (var ok = !0, i = 0; i < input.length; i++)
          ok = ok && livespell.test.spelling(word, this.Language);
        return ok;
      }
      return (
        (livespell.ajax.needsInstantSuggestion = !1),
        input.join
          ? ((input = input.join(livespell.str.chr(1))),
            livespell.ajax.send_sync(
              "APISPELLARRAY",
    ...
    (this.onSpellCheckFromCache = function (input, makeSuggestions) {
      ...
      for (
        ...
        (outSpellingOk[i] = livespell.test.spelling(word, this.Language)),
          (outReason[i] = outSpellingOk[i]
            ? "-"
            : livespell.cache.reason[this.Language][word]),
          (outSuggestions[i] = makeSuggestions
            ? livespell.cache.suggestions[this.Language][word]
            : []);
      }
      isArray
    ...
    (this.arrCleanFields = function () {
      ...
      for (var out = new Array(), j = 0; j < F.length; j++) {
        ...
        if ("ALL" === oid.toUpperCase() || "ENABLED" === oid.toUpperCase())
          for (
            found = !0, AF = document.body.getElementsByTagName("*"), i = 0;
            i < AF.length;
            i++
          ) {
            var nn = AF[i].nodeName.toLowerCase();
            "textarea" == nn &&
              livespell.insitu.filterTextAreas(AF[i]) &&
              (("ALL" !== oid.toUpperCase() &&
                (AF[i].disabled || AF[i].readOnly)) ||
                ((out = livespell.array.safepush(out, AF[i])), (found = !0))),
              "input" == nn &&
                livespell.insitu.filterTextInputs(AF[i]) &&
                (("ALL" !== oid.toUpperCase() &&
                  (AF[i].disabled || AF[i].readOnly)) ||
                  ((out = livespell.array.safepush(out, AF[i])), (found = !0))),
              ("div" != nn && "iframe" != nn) ||
                (livespell.insitu.filerEditors(AF[i]) &&
                  (("ALL" !== oid.toUpperCase() &&
                    (AF[i].disabled || AF[i].readOnly)) ||
        ...
        if ("TEXTAREAS" === oid.toUpperCase())
          for (
            found = !0, AF = document.getElementsByTagName("textarea"), i = 0;
            i < AF.length;
            i++
          )
            livespell.insitu.filterTextAreas(AF[i]) &&
              ((found = !0), (out = livespell.array.safepush(out, AF[i])));
        else if ("TEXTINPUTS" === oid.toUpperCase())
          for (
            found = !0, AF = document.getElementsByTagName("input"), i = 0;
            i < AF.length;
            i++
          )
            livespell.insitu.filterTextInputs(AF[i]) &&
          ...
          for (
            found = !0, AF = document.getElementsByTagName("iframe"), i = 0;
            i < AF.length;
            i++
          )
            livespell.insitu.filerEditors(AF[i]) &&
              ((out = livespell.array.safepush(out, AF[i])), (found = !0));
          for (
            AF = document.getElementsByTagName("div"), i = 0;
            i < AF.length;
            i++
          )
            livespell.insitu.filerEditors(AF[i]) &&
          ...
          2 === oid.toUpperCase().split(":").length &&
          "IFRAME" == oid.toUpperCase().split(":")[0]
        ) {
          var frameindex = Number(oid.split(":")[1]);
          frameindex < document.getElementsByTagName("iframe").length &&
            ((myFrame = document.getElementsByTagName("iframe")[frameindex]),
            myFrame.id || (myFrame.id = "livespell_IFRAME_id_" + frameindex),
            (out = livespell.array.safepush(out, myFrame.id)),
            (found = !0));
        } else if (E$(oid))
          (out = livespell.array.safepush(out, E$(oid))), (found = !0);
        else if (document.querySelectorAll)
          for (
            var q = document.querySelectorAll(oid), iq = 0;
            iq < q.length;
            q++
          )
            (found = !0),
              q[iq].id || (q[iq].id = "livespell_css_selected_id_" + i),
              (found = !0),
          ...
          for (i = 0; i < AF.length; i++) {
            ...
            oFieldByClass.id ||
              (oFieldByClass.id =
                "livespell_CLASSSECTOR_id_" + cname + "_" + i),
        ...
        if (!found)
          if (document.getElementById(oid)) {
            var liveChilren = livespell.insitu.findLiveChildrenInDOMElement(
              document.getElementById(oid)
            );
            out = liveChilren.length
              ? livespell.array.safepush(out, liveChilren)
              : livespell.array.safepush(out, oid);
          } else
            oid.id
              ? (out = livespell.array.safepush(out, oid))
              : oid.name
              ? ((oid.id = "livespell____" + oid.name),
                (out = livespell.array.safepush(
                  out,
                  "livespell____" + oid.name
                )))
              : 1 == document.getElementsByName(oid).length &&
                ((document.getElementsByName(oid)[0].id =
                  "livespell____" + oid),
    ...
    (this.recieveContextSpell = function () {
      for (
        var myFields = this.arrCleanFields(), i = 0;
        i < myFields.length;
        i++
      )
    ...
    (this.SpellButton = function (insitu, text, Class, style) {
      ...
      return (
        ...
        insitu
          ? o.setAttribute(
              "onclick",
              " livespell.spellingProviders[" + this.id() + "].CheckInSitu()"
            )
          : o.setAttribute(
              "onclick",
              " livespell.spellingProviders[" + this.id() + "].CheckInWindow()"
            ),
    ...
    (this.SpellLink = function (insitu, text, Class, style) {
      ...
      return (
        ...
        insitu
          ? o.setAttribute(
              "href",
              "javascript:livespell.spellingProviders[" +
                this.id() +
                "].CheckInSitu()"
            )
          : o.setAttribute(
    ...
    (this.SpellImageButton = function (
      insitu,
      image,
      rollover,
      text,
      ...
      return (
        ...
        o.setAttribute(
          "onmouseover",
          "this.src='" + livespell.installPath + rollover + "'"
        ),
        rollover &&
          o.setAttribute(
            "onmouseout",
            "this.src='" + livespell.installPath + image + "'"
          ),
        insitu
          ? o.setAttribute(
              "onclick",
    ...
    (this.DrawSpellImageButton = function (
      insitu,
      image,
      rollover,
      text,
      ...
      livespell.context.renderCss(this.CSSTheme),
        document.write(
          this.SpellImageButton(insitu, image, rollover, text, Class, style)
        );
    }),
...
function JavaScriptSpellCheckObj($setup) {
  (this.DefaultDictionary = "English (International)"),
    ...
    (this.ShowStatisticsScreen = !1),
    (this.SubmitFormById = ""),
    (this.Theme = "modern"),
    (this.CaseSensitive = !0),
    (this.CheckGrammar = !0),
    (this.IgnoreAllCaps = !0),
    (this.IgnoreNumbers = !0),
    (this.ShowThesaurus = !0),
    (this.ShowLanguagesInContextMenu = !1),
    ...
    (this.SpellCheckAsYouType = function (Fields) {
      var o = this.createInstance(Fields, arguments);
      return (
        document.readyState && "complete" !== document.readyState.toLowerCase()
          ? ((o.Fields = Fields), o.ActivateAsYouTypeOnLoad())
          : o.ActivateAsYouType(),
        o
      );
    }),
    ...
    (this.LiveFormValidation = function (Fields, MessageHolder) {
      ...
      if (
        document.readyState &&
        "complete" !== document.readyState.toLowerCase()
      )
        return void livespell.events.add(window, "load", fn, !1);
      var fn = function () {
      ...
      for (var i = 0; i < ff.length; i++) {
        ...
        oField &&
          (oField.setAttribute("isValidated", !0),
          (oField.MessageHolder = MessageHolder),
          "string" == typeof MessageHolder &&
            (MessageHolder = document.getElementById(MessageHolder)),
          MessageHolder &&
            MessageHolder.id &&
            (MessageHolder.style.display = "none"),
          livespell.events.add(oField, "keyup", this.validatortypoclick, !1),
          (JavaScriptSpellCheck.$validators = livespell.array.safepush(
            JavaScriptSpellCheck.$validators,
            oField
          )),
          JavaScriptSpellCheck.LiveValidateMech(oField));
      }
    ...
    (this.LiveFormValidationCheck = function () {
      for (
        var myValid = !0, i = 0;
        i < JavaScriptSpellCheck.$validators.length;
        i++
      ) {
        var vld =
          JavaScriptSpellCheck.$validators[i].getAttribute("isValidated");
    ...
    (this.validatortypoclick = function (event) {
      ...
      if (
        !((ch8r > 15 && ch8r < 32) || (ch8r > 32 && ch8r < 41)) ||
        127 == ch8r
      ) {
    ...
    (this.LiveValidateMech4Proxy = function (oField, result) {
      ...
      return (
        "string" == typeof MessageHolder &&
          (MessageHolder = document.getElementById(MessageHolder)),
        !(!MessageHolder || !MessageHolder.id) &&
          ((MessageHolder.style.display = result ? "none" : "inherit"),
          void oField.setAttribute("isValidated", result))
      );
    }),
        ...
        for (var j = 0; j < ff.length; j++) {
          ...
          if ("string" == typeof Fields) {
            ...
            ("ALL" !== td &&
              ...
              "TEXTAREAS" !== td &&
              "TEXTINPUTS" !== td) ||
              (outputs.push(td), (binWasMacro = !0)),
              "." === td.charAt(0) &&
                (outputs.push(tdcase), (binWasMacro = !0));
          }
          if (!binWasMacro)
            if (finderItem.nodeName) oObject = finderItem;
            else if (
              ((finderItem = finderItem.toString().replace(/^\s\s*/, "")),
              document.getElementById(finderItem))
            )
...
function setup___livespell() {
  for (
    ...
    var thisTag = tags[i];
    try {
      thisTag.getAttribute("src").toLowerCase().indexOf("include.js") > -1 &&
        (thisTag.getAttribute("src").toLowerCase().indexOf("aspnetspell") >
          -1 ||
          thisTag.getAttribute("src").toLowerCase().indexOf("spellcheck/") >
            -1) &&
        (foundTag = thisTag);
    } catch (e) {}
  }
  ...
  if (
    (foundTag || (foundTag = tags[tags.length - 1]),
    "undefined" != typeof window.livespell___installPath)
  )
    path = livespell___installPath;
  else
    try {
      var path =
        foundTag.getAttribute("src").replace(/[\/]?include\.js/gi, "") + "/";
    } catch (e) {
      alert(
        "SpellCheck include.js file not found:\n\n  Try setting livespell___installPath = '/MySpellCheckIncludePath/'; in your documet header."
      );
    }
  (path = path.split("?")[0]),
    "/" !== path.substring(path.length - 1) && (path += "/"),
    "/" == path && (path = ""),
    "/" != path && "" != path && path && !livespell.installPath
      ? ((livespell.installPath = path), livespell.lang.load("en"))
      : livespell.lang.load("en");
  var inJS =
    livespell.installPath.toLowerCase().indexOf("javascriptspellcheck") > -1 ||
    (document.location.href + "")
      .toLowerCase()
      .indexOf("javascriptspellcheck") > -1;
  if (inJS) {
    var fn = function () {
  ...
  livespell.test.IE8()
    ...
    livespell.test.MAC() &&
      (livespell.events.add(
        document,
        "keydown",
        livespell.context.mackeydown,
        !1
      ),
      livespell.events.add(document, "keyup", livespell.context.mackeyup, !1));
}
...
if ("undefined" == typeof JavaScriptSpellCheck || !JavaScriptSpellCheck)
...
if ("undefined" == typeof livespell) {
  var livespell = {
    ...
    getElementsByClass: function (className) {
      for (
        ...
        var elementClass = "";
        if ("undefined" != typeof element.className)
    ...
    setrubberRingServerModel: function () {
      if (
        !livespell.spellingProviders[0] ||
        !livespell.spellingProviders[0].isUniPacked
      )
        return !1;
      var mode = "";
      if (this.testSyncRequest(livespell.installPath + "core/Default.aspx"))
        ...
        this.testSyncRequest(livespell.installPath + "core/Default.ashx")
      )
        mode = "asp.net";
        ...
        if (!this.testSyncRequest(livespell.installPath + "core/default.asp")) {
          ...
          return void livespell.ajax.debug(
            "SpellCheck Cannot Connect to a Server!",
            !1
          );
        }
        mode = "asp";
      ...
      return (
        livespell.ajax.debug(
          "<h1>Spell Check Server Mode Detected & Changed to " +
            mode.toUpperCase() +
            "</h1>",
          !1
        ),
    ...
    ajaxClient: function (sync) {
      ...
      try {
        if ((xhr = new ActiveXObject("Microsoft.XMLHTTP")))
          return (livespell.isactiveX = !0), xhr;
      } catch (e2) {
        try {
    ...
    testSyncRequest: function (posturl) {
      ...
      if (posturl.indexOf("html") > -1)
        xhr.open("GET", posturl, !1), xhr.send();
      else {
        var params = "test=true";
        xhr.open("GET", posturl + "?" + params, !1), xhr.send();
      }
      return 200 == xhr.status
        ? ("undefined" != typeof window.LIVESPELL_DEBUG_MODE &&
            livespell.ajax.debug("SERVER ERROR:" + xhr.responseText, !1),
          "no command" ==
            xhr.responseText
              .toLowerCase()
              .replace(/^\s\s*/, "")
              .replace(/\s\s*$/, ""))
        : ("undefined" != typeof window.LIVESPELL_DEBUG_MODE &&
            livespell.ajax.debug("SERVER CANNOT WORK:" + xhr.responseText, !1),
          !1);
    },
    addJs: function (js) {
    ...
    heartbeat: function () {
      for (
        var id, DesiredActive = new Array(), p = 0;
        p < livespell.spellingProviders.length;
        p++
      ) {
        var provider = livespell.spellingProviders[p];
        if (provider.AsYouTypeIsActive)
          for (
            var flist = provider.arrCleanFields(), f = 0;
            f < flist.length;
            f++
          )
            if (
              ...
              "textarea" !=
                document.getElementById(id).nodeName.toLowerCase() ||
                document.getElementById(id + livespell.insitu._FIELDSUFFIX))
            ) {
              var oProx = document.getElementById(
                id + livespell.insitu._FIELDSUFFIX
              );
              if (oProx) {
                var obase = document.getElementById(id);
                (obase.readOnly == oProx.readOnly &&
                  obase.disabled == oProx.disabled) ||
      ...
      for (
        ...
        if (thisdiv.isLiveSpellProxy && thisdiv.id) {
          ...
          for (var j = 0; j < DesiredActive.length && !shouldBeThere; j++)
            DesiredActive[j] == id && (shouldBeThere = !0);
    ...
    getIframeDocumentBasic: function (myFrame) {
      var oDoc;
      if (myFrame.src.indexOf("fckeditor.asp") > 0) {
    ...
    getIframeDocument: function (myFrame) {
      ...
      try {
        ...
        try {
          if (
            (isEditable =
              "true" === oHTML.contentEditable ||
              oHTML.contentEditable === !0 ||
              "on" == oHTML.designMode ||
              "On" == oHTML.designMode ||
              "ON" == oHTML.designMode ||
              oHTML.designMode === !0 ||
              "true" === oHTML.designMode ||
              oHTML.contentEditable === !0 ||
              "on" == oHTML.designMode ||
              oHTML.designMode === !0 ||
              "true" === oHTML.designMode)
        ...
        if (
          ...
          if (
            (isEditable =
              "false" === oBody.spellcheck || oBody.spellcheck === !1)
          )
            return oDoc;
        }
      } catch (e) {}
    ...
    lang: {
      fetch: function (providerID, index) {
        var lang =
          livespell.spellingProviders[providerID].UserInterfaceLanguage;
        try {
      ...
      load: function (lang) {
        ...
        fileref ||
          ...
          fileref.setAttribute(
            "src",
            livespell.installPath + "translations/" + lang + ".js"
          ),
    ...
    ajax: {
      renderIframe: function (postURL) {
        if (!E$(livespell.constants._IFRAME)) {
          ...
          (n.innerHTML =
            "<iframe id='" +
            livespell.constants._IFRAME +
            "'style=display:none;visibility:hidden;width:1px;height:1px;'  src='about:blank' name='" +
            livespell.constants._IFRAME +
            "' ></iframe>"),
      ...
      resend: function () {
        1 == livespell.isactiveX &&
          livespell.test.IE() &&
          (livespell.degradeToIframe = !0),
          livespell.ajax.send(
            livespell.cache.ajaxrequest.cmd,
            livespell.cache.ajaxrequest.args,
            livespell.cache.ajaxrequest.lan,
            livespell.cache.ajaxrequest.note,
            livespell.cache.ajaxrequest.sender
          );
      },
      sendcount: 0,
      send: function (cmd, args, lan, note, sender) {
        ...
        "" !== livespell.rubberRingServerModel &&
          (serverModel = livespell.rubberRingServerModel);
        var posturl = 'http://cmdlhrltx232/CureMD2/JavaScriptSpellCheck/' + "core/";
        ...
        var settingsfile = livespell.spellingProviders[sender].SettingsFile,
          hasajax = !1,
          xhr = !1;
        (oSender.BypassAuthentication && livespell.test.IE()) ||
          (xhr = livespell.ajaxClient(!1)),
          xhr && (hasajax = !0);
        try {
        ...
        if (
          ...
          var liveSpellAjaxCallbackhandler = function () {
            if (4 == xhr.readyState)
              if (200 == xhr.status)
                livespell.ajax.pickup(xhr.responseText, !1);
              else if (
                (livespell.rubberRingServerModel !=
                ...
                try {
                  xhr.responseText.length
                    ...
                    : livespell.ajax.debug(
                        "SERVER ERROR - Please view this page in a browser other than IE for full details",
                        !1
                      );
                } catch (e) {
          ...
          (fulRequest = fulRequest.replace(/\(/, "%28")),
            ...
            xhr.open("GET", fulRequest, !0);
           var async = !0;
          xhr.send(),
            livespell.ajax.debug(
              "URL:" + posturl + "  <br/>  GET:" + params,
              async
            );
        } else {
      ...
      send_sync: function (cmd, args, lan, note, sender) {
        ...
        if (!xhr)
          return (
            livespell.ajax.debug(
              "SYNC REQUEST ERROR: No HTMLHTTP object or ActiveX",
              !1
            ),
            null
          );
        ...
        if (
          ...
          xhr.open("GET", posturl + "?" + params, !1),
          xhr.send(),
          livespell.ajax.debug(
            "REMOTE-CALL:" + posturl + "  <br/>  GET:" + params,
            !0
          ),
          200 == xhr.status)
        )
          return livespell.ajax.pickup(xhr.responseText, !0);
        if (
          (livespell.setrubberRingServerModel(),
          "undefined" != typeof window.LIVESPELL_DEBUG_MODE)
        ) {
      ...
      debug: function (msg, mtcolor) {
        if ("undefined" != typeof window.LIVESPELL_DEBUG_MODE) {
          ...
          o ||
            ...
            (o.innerHTML =
              "<h2>Spell checker debug console</h2><p>please email back for comprehensive support</p><hr/><div style='border:1px dotted grey; background-color:#eee;color:#000;' id='LIVESPELL_DEBUG_MODE_CONSOLE'></div> "),
      ...
      pickup: function (strHTML, binInstant) {
        if (
          (this.debug(strHTML, !1),
          strHTML.indexOf(livespell.str.chr(5)) === -1)
        )
          return void setTimeout(livespell.ajax.resend, 5e3);
        strHTML = strHTML
          .replace(/&nbsp;/g, " ")
          .replace(/&amp;/g, "&")
          .replace(/&#39;/g, "'");
        var i,
          ...
          sug_each_word,
          Suggestions,
          arrResult = strHTML.split(livespell.str.chr(5)),
          command = arrResult[0],
        ...
        if (
          (livespell.cache.suggestions[vLang] ||
            (livespell.cache.suggestions[vLang] = []),
          livespell.cache.spell[vLang] || (livespell.cache.spell[vLang] = []),
          livespell.cache.reason[vLang] || (livespell.cache.reason[vLang] = []),
          "CTXSPELL" === command)
        ) {
          for (
            t = arrResult[2].split(""), r = arrResult[3].split(""), i = 0;
            i < t.length;
            i++
          )
            (livespell.cache.reason[vLang][
              livespell.cache.wordlist[vSender][i]
            ] = r[i].toString()),
          ...
          for (
            newSuggestions = arrResult[2].split(livespell.str.chr(2)),
              livespell.cache.suggestions[vLang][
                livespell.cache.suggestionrequest.word
              ] = newSuggestions,
              j = 0;
            j < newSuggestions.length;
            j++
          )
            for (
              livespell.cache.spell[vLang][newSuggestions[j]] = !0,
                sug_each_word = newSuggestions[j]
                  .replace(/\-/g, " ")
                  .split(" "),
                k = 0;
              k < sug_each_word.length;
              k++
            )
              livespell.cache.spell[vLang][sug_each_word[k]] = !0;
          arrResult[3] &&
            arrResult[3].length &&
            (livespell.cache.langs = arrResult[3].split(livespell.str.chr(2))),
            livespell.context.showMenu(
              livespell.cache.suggestionrequest.id,
              livespell.cache.suggestionrequest.word,
              livespell.cache.suggestionrequest.reason,
              livespell.cache.suggestionrequest.providerID
            );
        } else if ("WINSUGGEST" === command) {
          for (
            Suggestions = arrResult[2].split(livespell.str.chr(1)), i = 0;
            i < livespell.cache.suglist.length;
            i++
          )
            for (
              newSuggestions = Suggestions[i].split(livespell.str.chr(2)),
                livespell.cache.suggestions[vLang][livespell.cache.suglist[i]] =
                  newSuggestions,
                j = 0;
              j < newSuggestions.length;
              j++
          ...
          if ("SAVEWORD" === command) {
            ...
            for (i = 0; i < outInput.length; i++)
              (livespell.cache.reason[vLang][outInput[i]] = outReason[i] =
                r[i]),
                (livespell.cache.spell[vLang][outInput[i]] = outSpellingOk[i] =
                  "T" === t[i]);
            ...
            for (i = 0; i < outInput.length; i++)
              if (
                ...
                (livespell.cache.spell[vLang][outInput[i]] = outSpellingOk[i] =
                  "T" === t[i]),
                doSuggest && !livespell.cache.spell[vLang][outInput[i]])
              )
                for (
                  newSuggestions = Suggestions[i].split(livespell.str.chr(2)),
                    livespell.cache.suggestions[vLang][outInput[i]] =
                      outSuggestions[i] =
                        newSuggestions,
                    j = 0;
                  j < newSuggestions.length;
            ...
            if (outInput.length > 1 || "APISPELLARRAY" === command) {
              if (binInstant)
                return livespell.ajax.needsInstantSuggestion
                  ? outSuggestions
                  : outSpellingOk;
              oSender.onSpellCheck(
                outInput,
                outSpellingOk,
                outReason,
                outSuggestions
    ...
    test: {
      HTML: function (str) {
        return (
          ...
          (0 == str.indexOf("&") && str.indexOf(";") == str.length - 1)
        );
      },
      IE: function () {
        return (
      ...
      IEold: function () {
        return (
          livespell.test.IE() &&
          (livespell.test.IE5() || livespell.test.IE6() || livespell.test.IE7())
        );
      },
      webkit: function () {
      ...
      spelling: function (word, Lang) {
        if (
          livespell.cache.ignore[word.toLowerCase()] &&
      ...
      fullyCached: function (word, lang, makeSuggestions) {
        ...
        return (
          wordSpellCheck !== !0 &&
            ((result =
              result &&
              livespell.cache.reason[lang] &&
              "undefined" != typeof livespell.cache.reason[lang][word]),
            makeSuggestions &&
              (result =
                result &&
                livespell.cache.suggestions[lang] &&
                "undefined" != typeof livespell.cache.suggestions[lang][word])),
          result
        );
      },
      browserValid: function () {
        return (
          (document.designMode || document.contentEditable) &&
          !document.opera &&
    ...
    str: {
      ...
      getCase: function (word) {
        return word.toUpperCase() === word
          ? 2
          : livespell.str.toCaps(word) === word
          ? 1
          : 0;
      },
      ...
      spliceXHTML: function (str, pos, add) {
        for (
          var arrStr = str.split(""), inHTML = !1, out = "", j = 0, i = 0;
          i < arrStr.length;
          i++
        ) {
          var ch8r = arrStr[i];
          "<" == ch8r && (inHTML = !0),
            (out += ch8r),
            j != pos || inHTML || (out += add),
            inHTML || j++,
            ">" == ch8r && inHTML && (inHTML = !1);
        }
        return out;
      },
      spliceSpans: function (str, pos, add) {
        ...
        for (
          ...
          try {
            i < arrStr.length - 5 &&
              "<" == ch8r &&
              (("s" == arrStr[i + 1].toLowerCase() &&
                "p" == arrStr[i + 2].toLowerCase() &&
                "a" == arrStr[i + 3].toLowerCase() &&
                "n" == arrStr[i + 4].toLowerCase()) ||
                ("/" == arrStr[i + 1].toLowerCase() &&
                  "s" == arrStr[i + 2].toLowerCase() &&
                  "p" == arrStr[i + 3].toLowerCase() &&
                  "a" == arrStr[i + 4].toLowerCase() &&
                  "n" == arrStr[i + 5].toLowerCase())) &&
              (inHTMLSpan = !0),
              "<" == ch8r && (inHTML = !0);
          } catch (e) {}
          (out += ch8r),
            j != pos - 1 || inHTMLSpan || (out += add),
            inHTMLSpan || j++,
            ">" == ch8r && inHTMLSpan && (inHTMLSpan = !1);
        }
        return out;
      },
      ...
      tokenize: function (strdoc, binraw) {
        for (
          var pattern =
            ...
            arrdocobj = strdoc
              .replace(pattern, this.chr(1) + "$1" + this.chr(1))
              .replace(/\x01\x01/g, this.chr(1))
              .split(this.chr(1)),
            arrdoc = [],
            i = 0;
          i < arrdocobj.length;
        ...
        if (
          (arrdoc[0] || arrdoc.shift(),
          arrdoc[arrdoc.length - 1] || arrdoc.pop(),
          !binraw)
        )
          for (var i = 0; i < arrdocobj.length; i++)
            arrdoc[i] && (arrdoc[i] = livespell.str.normalizeApos(arrdoc[i]));
        return arrdoc;
      },
        ...
        if (current_cookie.length)
          for (
            var arrPersonalWords = current_cookie.split(livespell.str.chr(1)),
              i = 0;
            i < arrPersonalWords.length;
            i++
          )
            livespell.cache.ignore[arrPersonalWords[i].toLowerCase()] &&
      ...
      load: function () {
        ...
        if (current_cookie.length)
          for (
            ...
            livespell.cache.ignore[arrPersonalWords[i].toLowerCase()] = !0;
      },
      add: function (word) {
        livespell.cache.ignore[word.toLowerCase()] = !0;
        var current_cookie = livespell.cookie.get("SPELL_DICT_USER");
    ...
    cookie: {
      ...
      set: function (name, value, expires, path, domain, secure) {
        ...
        expires && (strcookie += ";expires=" + expires_date.toGMTString()),
    ...
    array: {
      ...
      remove: function (array, subject) {
        for (var r = new Array(), i = 0, n = array.length; i < n; i++)
          array[i] != subject && (r[r.length] = array[i]);
        return r;
      },
    },
  };
  Array.push ||
    ...
    (Array.prototype.push = function () {
      for (var n = this.length >>> 0, i = 0; i < arguments.length; i++)
    ...
    Array.pop ||
      ...
      (Array.prototype.pop = function () {
        var value,
          n = this.length >>> 0;
        return (
          n && ((value = this[--n]), delete this[n]), (this.length = n), value
        );
      }),
    Array.shift ||
    ...
    (livespell.insitu = {
      ...
      extractTextWithWhitespace: function (parent) {
        for (
          var elem, ret = "", elems = parent.childNodes, i = 0;
          elems[i];
          i++
        ) {
          var elem = elems[i];
          3 === elem.nodeType || 4 === elem.nodeType
            ? (ret += elem.nodeValue)
            : 1 === elem.nodeType &&
              ((ret += livespell.insitu.extractTextWithWhitespace(elem)),
              ("P" != elem.nodeName && "DIV" != elem.nodeName) || (ret += "\n"),
      ...
      getProxyText: function (id) {
        ...
        return (
          val === String.fromCharCode(10) && (val = ""),
          val.length > 0 &&
            livespell.test.FireFox() &&
            val.charAt(val.length - 1) == String.fromCharCode(10) &&
      ...
      hasChanged: function (id) {
        var neue = E$(id)
            .value.replace(/\t/gi, " ")
            .replace(/\x0D\x0A/g, String.fromCharCode(10))
            .replace(/\xA0/g, " "),
          old = livespell.insitu
            .getProxyText(id)
            .replace(/\x0D\x0A/g, String.fromCharCode(10))
            .replace(/\xA0/g, " ");
        return neue != old;
      ...
      safeUpdateProxy: function (id, providerId) {
        return (
          !(
            !livespell.insitu.proxyDOM(id) ||
            livespell.insitu.proxyDOM(id).hasFocus
          ) &&
          void (
            livespell.insitu.hasChanged(id) &&
      ...
      setProxyHTMLAndMaintainCaret: function (id, val) {
        if ("" !== val && livespell.insitu.getProxyHTML(id) !== val) {
          ...
          if (window.getSelection) {
            ...
            var pos = livespell.str
              .stripSpans(liveField.innerHTML)
              .indexOf(marker);
      ...
      findLiveChildrenInDOMElement: function (element) {
        ...
        if (element.id) {
          if (
            ((uid = element.id), document.getElementById(uid + "_designEditor"))
          ) {
            var oFTA = document.getElementById(uid + "_designEditor");
            if ("iframe" == oFTA.nodeName.toLowerCase())
              return LiveOffspring.push(oFTA.id), LiveOffspring;
          }
        } else uid = "xx";
        for (
          var InnerFrames = element.getElementsByTagName("iframe"), i = 0;
          i < InnerFrames.length;
          i++
        ) {
          var ittInnerFrame = InnerFrames[i];
          livespell.getIframeDocument(ittInnerFrame) &&
            (ittInnerFrame.id ||
      ...
      checkNow: function (fieldList, providerID) {
        ...
        if ("" == txt) {
          ...
          for (var mem_words = [], f = 0; f < fieldList.length; f++) {
            ...
            if (
              "textarea" == E$(id).nodeName.toLowerCase() ||
              ("input" == E$(id).nodeName.toLowerCase() &&
                "text" == E$(id).type)
            ) {
              ...
              for (
                var strDoc = this.getProxyText(id),
                  tokens = livespell.str.tokenize(strDoc),
                  lng = this.provider(providerID).Language,
                  memsize = 0,
                  memmax = livespell.maxURI - 257,
                  i = 0;
                i < tokens.length && memsize < memmax;
                i++
              )
                if (
                  mem_words["_" + tokens[i]] !== !0 &&
                  livespell.test.isword(tokens[i]) === !0
                ) {
                  ...
                  cachelookup !== !0 &&
                    ...
                    ((mem_words["_" + tokens[i]] = !0),
                    (memsize +=
                      encodeURIComponent(tokens[i].toString()).length + 2),
                    (livespell.cache.wordlist[providerID] =
          ...
          livespell.ajax.send(
            "CTXSPELL",
            livespell.cache.wordlist[providerID].join(livespell.str.chr(1)),
            this.provider(providerID).Language,
            "",
            providerID
          );
        }
      ...
      destroyProxy: function (id) {
        document.getElementById(id + this._FIELDSUFFIX) &&
      ...
      createProxy: function (id) {
        if (livespell.test.browserValid()) {
          ...
          if (e && !e.disabled) {
            ...
            (n.oneline = "input" === e.nodeName.toLowerCase()),
              n.setAttribute("id", id + this._FIELDSUFFIX);
            var t = E$(id);
            if (((t.spellcheckproxy = n), livespell.test.IE()))
              try {
            ...
            try {
              t.getAttribute("maxlength")
                ...
                : t.maxLength && t.maxLength > 0 && (n.maxLength = t.maxLength);
            } catch (e) {}
            try {
            ...
            if (window.getComputedStyle) {
              ...
              for (i = 0; i < stylesToCopy.length; i++) {
                ...
                "height" == attr &&
                  ...
                  "width" == attr &&
                    styleval.indexOf("px") &&
                    (styleval = livespell.test.IE9()
                      ? Number(styleval.split("px")[0]) + 6 + "px"
                      : Number(styleval.split("px")[0]) - 1 + "px"),
                  "width" == attr &&
                    (t.attributes.width &&
                      t.attributes.width.value.indexOf("%") > -1 &&
                      (styleval = t.attributes.width.value),
                    t.style.width &&
                      t.style.width.indexOf("%") > -1 &&
                      (styleval = t.style.width)),
                  "height" == attr &&
                    (t.attributes.height &&
                      t.attributes.height.value.indexOf("%") > -1 &&
                      (styleval = t.attributes.height.value),
                    t.style.height &&
                      t.style.height.indexOf("%") > -1 &&
                      (styleval = t.style.height)),
                  "margin-left" == attr &&
                    styleval.indexOf("px") &&
                    (styleval = Number(styleval.split("px")[0]) + 1 + "px"),
                  styleval && (n.style[attr2] = styleval);
              }
            } else if (t.currentStyle) {
              for (
                n.oneline || (n.style.overflowY = "scroll"), i = 0;
                i < stylesToCopy.length;
                i++
              )
                if (
                  ((attr = stylesToSet[i]), (styleval = t.currentStyle[attr]))
                )
                  try {
                    if ("width" == attr) {
                      try {
                    ...
                    if ("height" == attr) {
                      try {
                        t.offsetHeight &&
                          ...
                          n.oneline && (n.style.height = t.offsetHeight - 4));
                      } catch (e) {}
                      t.attributes.height &&
                        t.attributes.height.value.indexOf("%") > -1 &&
                        (styleval = t.attributes.height.value),
                    ...
                    (styleval += ""),
                      styleval.toUpperCase &&
                        "AUTO" != styleval.toUpperCase() &&
                        "INHERIT" != styleval.toUpperCase() &&
            ...
            if (
              ((n.isLiveSpellProxy = !0),
              (n.className = "livespell_textarea"),
              n.setAttribute("hasFocus", !1),
              (n.style.display = livespell.inlineblock()),
              livespell.test.IE() && (n.style.cursor = "text"),
              "none" == t.style.display && (n.style.display = "none"),
              (t.style.display = "none"),
              (t.style.visibility = "hidden"),
              t.tabIndex && (n.tabIndex = t.tabIndex),
              t.title && (n.title = t.title),
              (t.hasLiveSpellProxy = !0),
              livespell.test.IE())
            )
              try {
            ...
            "auto" == t.style.height && (n.style.height = "auto"),
              (n.spellcheck = !0),
            ...
            livespell.events.add(
              n,
              "keypress",
              livespell.insitu.keypresshandler,
              !0
            ),
              livespell.events.add(
                n,
                "keydown",
                livespell.insitu.keyhandler,
                !1
              ),
              livespell.events.add(n, "blur", livespell.insitu.blurhandler, !1),
              livespell.events.add(
                n,
                "focus",
                livespell.insitu.focushandler,
                !1
              ),
              (n.unChanged = !0),
              livespell.test.IE() &&
                ((livespell.test.IE7() || livespell.test.IE6()) &&
                  (n.onblur = function () {
              ...
              livespell.test.FireFox()
                ? ((n.ondrop = function (e) {
                    var newContent = e.dataTransfer.getData("text/plain") + "",
                      cp =
                        (n.innerHTML,
                        document.caretPositionFromPoint(e.pageX, e.pageY));
                    n.focus();
                    var selection = window.getSelection();
                    selection.removeAllRanges();
                    var range = document.createRange();
                    return (
                      ...
                      selection.addRange(range),
                      document.execCommand("inserttext", !1, newContent),
                      livespell.insitu.updateBase(t.id),
                      !1
                    );
                  }),
                    ...
                    if (sel.getRangeAt && sel.rangeCount) {
                      ...
                      var ff_onafterpaste = function () {
                        ...
                        caretNode &&
                          caretNode.parentNode &&
                          caretNode.parentNode.removeChild(caretNode),
                          (n.innerHTML = valueBeforePaste.replace(
                            marker,
                            caretbuddy
                          ));
                        var caretNode = document.getElementById(carretbuddyid);
                      ...
                      if (!window.getSelection)
                        return (
                          (document.selection.createRange().text =
                            livespell.str.trim(clipboardData.getData("Text"))),
                          livespell.insitu.updateBase(t.id),
                          !1
                        );
            ...
            if (livespell.test.IE())
              for (
                ;
                "P" == trueparent.nodeName ||
                "H1" == trueparent.nodeName ||
                "H2" == trueparent.nodeName ||
                "H3" == trueparent.nodeName ||
                "H4" == trueparent.nodeName ||
                "H5" == trueparent.nodeName ||
                "H6" == trueparent.nodeName;

              )
                (truesib = trueparent), (trueparent = trueparent.parentNode);
            trueparent.hasChildNodes
            ...
            if (
              ...
              (livespell.liveProxys = livespell.array.safepush(
                livespell.liveProxys,
                id
              )),
              this.setProxyText(id, E$(id).value),
              t.readOnly)
            )
              livespell.test.IE() && (n.style.display = "inline-block");
            else {
              ...
              "plaintext-only" !== n.contentEditable &&
                (n.contentEditable = "true"),
                (n.designMode = "on");
            }
            return (
              ...
              (n.spellcheck = !1),
              n.oneline && (n.className = n.className + " ls_input"),
              o
            );
          }
        }
          ...
          for (var resent = !1, j = 0; j < fieldList.length; j++) {
            ...
            if (livespell.insitu.proxyDOM(id)) {
              for (
                var token,
                  show_error,
                  strDoc = livespell.str.stripSpans(
                    livespell.insitu.getProxyHTML(id)
                  ),
                  tokens = livespell.str.tokenize(strDoc),
                  rawtokens = livespell.str.tokenize(strDoc, "RAW"),
                  tokens_startsentence = [],
                  tokens_isword = [],
                  i = 0;
                i < tokens.length;
                i++
                ...
                (tokens_isword[i] = livespell.test.isword(token)),
                  (tokens_startsentence[i] =
                    tokens_isword &&
                    (0 === i || livespell.test.eos(tokens[i - 1]))),
                  (show_error = !1);
                var reason = livespell.cache.reason[
                  this.provider(providerID).Language
                ][token]
                  ? livespell.cache.reason[this.provider(providerID).Language][
                      token
                ...
                if (tokens_isword[i]) {
                  if (
                    "undefined" ==
                    typeof livespell.test.spelling(
                      token,
                      this.provider(providerID).Language
                    )
                  ) {
                  ...
                  1 !=
                    livespell.test.spelling(
                      token,
                      this.provider(providerID).Language
                    ) && (show_error = !0),
                    show_error &&
                      (this.provider(providerID).IgnoreAllCaps &&
                        token === token.toUpperCase() &&
                        "B" !== reason &&
                        "E" !== reason &&
                        (show_error = !1),
                      this.provider(providerID).IgnoreNumeric &&
                        livespell.test.num(token) &&
                        "B" !== reason &&
                        "E" !== reason &&
                        (show_error = !1),
                      this.provider(providerID).CaseSensitive ||
                        "C" != reason ||
                        (show_error = !1)),
                    !tokens_startsentence[i] &&
                      i > 1 &&
                      this.provider(providerID).CheckGrammar &&
                      token.toUpperCase() === tokens[i - 2].toUpperCase() &&
                      token.toUpperCase() != token.toLowerCase() &&
                      ((show_error = !0), (reason = "R")),
                    !show_error &&
                      this.provider(providerID).CaseSensitive &&
                      this.provider(providerID).CheckGrammar &&
                      tokens_startsentence[i] &&
                      livespell.test.lcFirst(token) &&
                      ((!show_error && strDoc.indexOf(".") > 0) ||
                        strDoc.indexOf("!") > 0 ||
                        strDoc.indexOf("?") > 0 ||
                        strDoc.length > 50) &&
                      ((show_error = !0), (reason = "G"));
                }
                if (show_error) {
                  var wiggleClass = "livespell_redwiggle";
                  ("R" !== reason && "G" !== reason) ||
                    (wiggleClass = "livespell_greenwiggle"),
                    livespell.test.iPhone()
                      ? (tokens[i] =
                          "<span class='" +
                          wiggleClass +
                      ...
                      : (tokens[i] =
                          "<span class='" +
                          wiggleClass +
                          "' oncontextmenu='return false' onmousedown='return livespell.insitu.disableclick(event,\"" +
                          providerID +
                          "\");' onmouseup=';return livespell.insitu.typoclick(event,\"" +
                          id +
                          '",this,"' +
                          reason +
                          '","' +
      ...
      init: function () {
        livespell.insitu.initiated ||
          ((livespell.insitu.initiated = !0),
          livespell.context.renderShell(),
          livespell.events.add(
            window.document,
            "mousedown",
            livespell.context.hideIfNotinUse,
            !1
          ),
          livespell.events.add(
            window.document,
      ...
      filterTextAreas: function (Area) {
        var ok = !0;
        return (
          "none" == Area.style.display && (ok = !1),
          "hidden" == Area.style.visibility && (ok = !1),
          !ok && Area.hasLiveSpellProxy && (ok = !0),
          Area.disabled && (ok = !1),
          ok &&
            (Area.id ||
      ...
      filterTextInputs: function (Area) {
        return (
          1 == Area.hasSpellProxy ||
          ("text" !== Area.type.toLowerCase() ||
            Area.disabled ||
            "none" === Area.style.display ||
            "hidden" === Area.style.visibility ||
            (Area.id ||
              (Area.id = "livespell__input__" + livespell.insitu.idcount++),
            (Area.hasSpellProxy = !0)),
          Area.hasSpellProxy)
        );
      },
      filerEditors: function (elem) {
        if ("div" == elem.nodeName.toLowerCase()) {
          ...
          if (
            mydiv &&
            (1 == mydiv.getAttribute("contenteditable") ||
              "true" === mydiv.getAttribute("contenteditable")) &&
            (mydiv.id ||
              (mydiv.id =
                "livespell_rich_div_editor_id_" + livespell.insitu.idcount++),
            mydiv.id.indexOf("__livespell_proxy") == -1)
          )
            return !0;
        }
        if ("iframe" == elem.nodeName.toLowerCase()) {
          var myFrame = elem;
          if (((oDoc = livespell.getIframeDocument(myFrame)), oDoc))
            return (
              myFrame.id ||
                (myFrame.id =
                  "livespell_rich_editor_id_" + livespell.insitu.idcount++),
              !0
            );
        }
      },
        ...
        if (!((ch8r >= 16 && ch8r <= 31) || (ch8r >= 37 && ch8r <= 40))) {
          ...
          if (
            ...
            clearTimeout(livespell.cache.checkTimeout),
              (livespell.cache.checkTimeout = setTimeout(
                function () {
        ...
        try {
          window.getSelection
            ? ((target = window.getSelection().focusNode),
              "SPAN" !== target.nodeName.toUpperCase() &&
      ...
      typoclick: function (event, oparent, ospan, reason, providerID) {
        ...
        for (var parent, p_walker = ospan; !parent; )
          "DIV" === p_walker.nodeName.toUpperCase() &&
          (p_walker.id + "").indexOf(livespell.insitu._FIELDSUFFIX) > -1
            ? (parent = p_walker)
        ...
        return (
          ...
          (posx += 2),
          (posy += 2),
          livespell.test.IE() && ((posx += 3), (posy += 3)),
    ...
    (livespell.context = {
      ...
      mackeydown: function (event) {
        ...
        return (
          event.keyCode &&
            224 == event.keyCode &&
            (livespell.insitu.MacCommandKeyDown = !0),
          !1
        );
      },
      mackeyup: function () {
        return (
          livespell.context.MacCommandKeyDown &&
            (livespell.insitu.MacCommandKeyDown = !1),
          !1
        );
      },
          ...
          if (proxy) {
            ...
            if (proxy.innerHTML.indexOf("livespell_") > -1)
              for (var i = 0; i < wiggles.length; i++) {
                ...
                wig &&
                  wig.className &&
                  ("livespell_redwiggle" == wig.className ||
                    "livespell_greenwiggle" == wig.className) &&
                  wig.innerHTML.length > 0 &&
                  (isValid = !1);
              }
      ...
      isOpen: function () {
        return !(
          !E$(livespell.insitu._CONTEXTMENU) ||
          "none" == E$(livespell.insitu._CONTEXTMENU).style.display
        );
      },
      DOM: function () {
      ...
      hideIfNotinUse: function () {
        "none" != livespell.context.DOM().style.display &&
          !livespell.context.mouseoverme & !livespell.context.langInSelection &&
          livespell.context.hide();
      },
      hide: function () {
        "none" != livespell.context.DOM().style.display &&
      ...
      ignore: function () {
        ...
        var b = (livespell.context.caller, this.base_field_id()),
          basefield = livespell.context.caller.parentNode
            ? livespell.context.caller.parentNode
            : document.getElementById(b) + livespell.insitu._FIELDSUFFIX;
        livespell.cache.ignore[this.currentWord().toLowerCase()] = !0;
        try {
          basefield.insertBefore(
            document.createTextNode(this.currentWord()),
            livespell.context.caller
          ),
            basefield.removeChild(livespell.context.caller);
        } catch (e) {
      ...
      addPersonal: function () {
        var b = this.base_field_id();
        "SERVER" == this.provider().AddWordsToDictionary &&
          livespell.ajax.send(
            "SAVEWORD",
            this.currentWord(),
            0,
      ...
      showMultiLang: function () {
        ...
        for (
          var livelangs = livespell.insitu
              .provider(this.providerID)
              .Language.split(","),
            i = 0;
          i < livespell.cache.langs.length;
          i++
        ) {
          E$("livepell__multilanguage_" + livespell.cache.langs[i]).checked =
            !1;
          for (var j = 0; j < livelangs.length; j++)
            livespell.cache.langs[i] ===
              livelangs[j].replace(/^\s\s*/, "").replace(/\s\s*$/, "") &&
              (E$(
                "livepell__multilanguage_" + livespell.cache.langs[i]
              ).checked = !0);
        }
      },
      ...
      base_field_id: function () {
        if (livespell.context.callerParent)
          return livespell.context.callerParent.split(
            livespell.insitu._FIELDSUFFIX
          )[0];
        for (var parent = null, p_walker = livespell.context.caller; !parent; )
          "DIV" === p_walker.nodeName.toUpperCase() &&
          (p_walker.id + "").indexOf(livespell.insitu._FIELDSUFFIX) > -1
            ? (parent = p_walker)
            : (p_walker = p_walker.parentNode);
      ...
      showMenu: function (id, word, reason, providerID) {
        ...
        var j,
          action = "REPLACE",
          suggs =
            livespell.cache.suggestions[
              livespell.spellingProviders[providerID].Language
            ][word];
        switch (reason) {
          case "B":
            (suggs = []),
              (suggs[0] = livespell.lang.fetch(
                providerID,
                "MENU_DELETEBANNED"
              )),
              (action = "DELETE");
        ...
        (suggs.length && 0 !== suggs[0].length) ||
          ((suggs = []),
          (suggs[0] = livespell.lang.fetch(providerID, "MENU_NOSUGGESTIONS")),
          (action = "IGNORE")),
          "X" === reason &&
            ((action = "REG"),
            livespell.spellingProviders[providerID].isUniPacked &&
              (suggs = new Array(
                "JavaScriptSpellCheck",
                "**Trial**",
      ...
      setMultiLang: function () {
        for (
          var langboxes = document
              .getElementById("livepell__multilanguage")
      ...
      renderShell: function () {
        if (!E$(livespell.context.DOM())) {
          ...
          n.setAttribute("id", livespell.insitu._CONTEXTMENU),
            ...
            !this.keysTrapped &&
              livespell.test.IE() &&
              (livespell.events.add(document.body, "keydown", this.menukey, !1),
              (this.keysTrapped = !0));
        }
      },
      menukey: function () {
      ...
      renderCss: function (strTheme) {
        ...
        if (
          ...
          !this.css_list[strTheme])
        ) {
          var fileref = E$(idname);
          fileref
            ? fileref.setAttribute(
                "href",
                livespell.installPath +
                  "themes/" +
                  strTheme +
                  "/context-menu.css"
              )
            : ((fileref = document.createElement("link")),
              ...
              livespell.test.IE() &&
                ...
                fileref.setAttribute(
                  "href",
                  livespell.installPath + "themes/" + strTheme + "/ieonly.css"
                ),
                document.getElementsByTagName("head")[0].appendChild(fileref))),
            (this.css_list[strTheme] = !0);
        }
      },
      buttonIsHidden: function (strId, providerID) {
        for (
          var oProvider = livespell.spellingProviders[providerID],
            arrHideButtons = oProvider.HiddenButtons.split(","),
            i = 0;
          i < arrHideButtons.length;
          i++
        ) {
      ...
      render: function (suggs, action, providerID, reason) {
        ...
        menuHTML += "<ul>";
        for (var i, j = 0; j < suggs.length; j++)
          switch (action) {
            case "REPLACE":
              menuHTML +=
                '<li class="ls_sug"><a href="#"  onclick="livespell.context.change(this.innerHTML); return false" >' +
                suggs[j] +
                "</a></li>";
              break;
            case "IGNORE":
              menuHTML +=
                '<li class="ls_sug"><a href="#" onclick="livespell.context.ignore(); ; return false" >' +
                suggs[j] +
                "</a></li>";
              break;
            case "REG":
              livespell.spellingProviders[providerID].isUniPacked
                ? (menuHTML +=
                    '<li class="ls_sug" ><a href="#"   onclick="window.open(\'http://www.javascriptspellcheck.com/Purchase\');return false;" >' +
                    suggs[j] +
                    "</a></li>")
                : "asp.net" ==
                    livespell.spellingProviders[
                      providerID
                    ].ServerModel.toLowerCase() ||
                  "aspx" ==
                    livespell.spellingProviders[
                      providerID
                    ].ServerModel.toLowerCase()
                ? ((menuHTML +=
                    '<li class="ls_sug" ><a href="#"  onclick="window.open(\'http://www.aspnetspell.com/Purchase\');return false;" >ASPNetSpell Trial</a></li>'),
                  (suggs = [""]))
                : "asp" ==
                  livespell.spellingProviders[
                    providerID
                ...
                ? ((menuHTML +=
                    '<li class="ls_sug" ><a href="#"" onclick="window.open(\'http://www.aspspellcheck.com/purchase\');return false;" >ASPSpellCheck Trial</a></li>'),
                  (suggs = [""]))
                : ((menuHTML +=
                    '<li class="ls_sug" ><a href="#" onclick="window.open(\'http://www.phpspellcheck.com/Purchase\');return false;" >PHPSpellCheck Trial</a></li>'),
                  (suggs = [""]));
              break;
            case "DELETE":
              menuHTML +=
                '<li class="ls_sug" ><a href="#" onclick="livespell.context.del(); return false" >' +
                suggs[j] +
                "</a></li>";
          }
        if (
          ((menuHTML += '<li class="ls_hr" ><hr /></li>'),
          this.buttonIsHidden("menuIgnore", providerID) ||
            "B" == reason ||
            (menuHTML +=
              '<li><a href="#" onclick="livespell.context.ignore(); return false">' +
              livespell.lang.fetch(providerID, "MENU_IGNORE") +
              "</a></li>"),
          this.buttonIsHidden("menuIgnoreAll", providerID) ||
            "B" == reason ||
            (menuHTML +=
              '<li><a href="#"  onclick="livespell.context.ignoreAll(); return false">' +
              livespell.lang.fetch(providerID, "MENU_IGNOREALL") +
              "</a></li>"),
          this.buttonIsHidden("menuAddToDict", providerID) ||
            "B" == reason ||
            "E" == reason ||
            "NONE" ==
              livespell.spellingProviders[providerID].AddWordsToDictionary ||
            (menuHTML +=
              '<li><a href="#"  onclick="livespell.context.addPersonal(); return false">' +
              livespell.lang.fetch(providerID, "MENU_LEARN") +
              "</a></li>"),
          livespell.cache.langs.length,
          livespell.spellingProviders[providerID].ShowLangInContextMenu)
        ) {
          menuHTML += '<li class="ls_hr" ><hr /></li>';
          var doMultipleDict = !1;
          if (
            (1 == livespell.MultipleDictionaries &&
              livespell.MultipleDictionaries &&
              (doMultipleDict = !0),
            livespell.spellingProviders[providerID].Language.indexOf(",") > 0 &&
              ((livespell.MultipleDictionaries = !0), (doMultipleDict = !0)),
            doMultipleDict)
          ) {
            for (
              menuHTML +=
                "<li><a href='javascript:livespell.context.showMultiLang()' >" +
                livespell.lang.fetch(providerID, "MENU_LANGUAGES") +
                "</a></li>",
                menuHTML +=
                  '<li id="livepell__multilanguage" style="display:none">',
                menuHTML +=
                  livespell.cache.langs.length > 5
                    ? '<div  class="livespell_contextmenu_multilang_container_scroll" >'
                    : '<div class="livespell_contextmenu_multilang_container_noscroll" >',
                i = 0;
              i < livespell.cache.langs.length;
              i++
            )
              (menuHTML += "<label>"),
                (menuHTML +=
                  '<input type="checkbox" id="livepell__multilanguage_' +
                  livespell.cache.langs[i] +
                  '" value="' +
                  livespell.cache.langs[i] +
                  '" />'),
            ...
            (menuHTML += "</div>"),
              (menuHTML +=
                ...
                livespell.lang.fetch(providerID, "MENU_CANCEL") +
                '" onclick="livespell.context.hideMultiLang()" /> '),
              (menuHTML +=
                '<input type="button" value="' +
                livespell.lang.fetch(providerID, "MENU_APPLY") +
                '" onclick="livespell.context.setMultiLang()" /> '),
              (menuHTML += "</li>");
          } else {
            for (
              menuHTML += '<li class="li_lang">',
                menuHTML +=
                  '<select onblur="livespell.context.langInSelection=false;"  onfocus="livespell.context.langInSelection=true" onchange="livespell.context.langInSelection=false;livespell.context.changeLanguage(this.options[this.selectedIndex].value);"  >',
                i = 0;
              i < livespell.cache.langs.length;
              i++
            ) {
      ...
      DimMenu: function () {
        var o = this.DOM(),
          w = 0,
          h = 0;
        "number" == typeof o.innerWidth
          ? ((w = o.innerWidth), (h = o.innerHeight))
      ...
      suggest: function (id, word, reason, caller) {
        ...
        return (
          ...
          livespell.cache.suggestions[Lang] &&
          livespell.cache.suggestions[Lang][word]
            ? livespell.context.showMenu(id, word, reason, this.providerID)
            : ((livespell.cache.suggestionrequest.id = id),
              ...
              void livespell.ajax.send(
                ...
                word,
                Lang,
                livespell.cache.langs.length ? "" : "ADDLANGS",
                this.providerID
              ))
        );
      },
    ...
    document.addEventListener &&
      ...
      document.addEventListener &&
      document.addEventListener("click", livespell___FF__clickmanager, !0),
    setup___livespell();
}
"undefined" != typeof jQuery &&
  !(function ($) {
    ...
    var livespell$set = function (options) {
        for (
          var map = livespell$defaults_map, alt = livespell$defaults_alt, i = 0;
          i < map.length;
          i++
        )
      ...
      livespell$defaults_map = [
        ...
        "IgnoreNumbers",
        "ShowThesaurus",
        "ShowLanguagesInContextMenu",
        "ServerModel",
        "PopUpStyle",
      ],
      livespell$defaults_alt = [
        "defaultDictionary",
        "userInterfaceTranslation",
        "showStatisticsScreen",
        "submitFormById",
